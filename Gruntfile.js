...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    shell: {
      ...
      csharpCompile: {
        command: 'xbuild /m /verbosity:m /nologo src/csharp/Facebook.CSSLayout.sln /p:Configuration=Release /t:"Facebook_CSSLayout:Rebuild" /t:"Facebook_CSSLayout_Tests:Rebuild"'
      },
      csharpTestExecute: {
